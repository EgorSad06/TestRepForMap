...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function generateMapImage() {
        ...
        try {
            ...
            backgroundRect.setAttribute('x', 0); // Position at 0,0 to cover the entire SVG
            backgroundRect.setAttribute('y', 0); // Position at 0,0 to cover the entire SVG
            backgroundRect.setAttribute('width', svgWidth); // Cover the entire SVG
            backgroundRect.setAttribute('height', svgHeight); // Cover the entire SVG
            ...
            // Step 1: Generate the full SVG image with white background
